...
public class BISalesIntegrationServiceImpl implements SalesIntegrationService {
    ...
    public void publishSaleToBI(String carModel, int unitsSold, double revenue, String dealerId, String region,
        ...
        try {
            ...
            // Use the new facade to write to the BI subsystem, dropping the "sales_lead"
            // argument
            Object newId = facade.businessIntelligenceSubsystem().create("sales_records", record);
            logger.info("Successfully published sale to BI. Record ID: " + newId);

        } catch (Exception e) {
            // Graceful Degradation: Do not throw the error. Just log it so the system
            // doesn't crash.
